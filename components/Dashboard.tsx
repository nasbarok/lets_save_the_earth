...
import { EcoPointsIcon, SupportIcon, CalendarIcon, MenuIcon, PlayIcon, PauseIcon, ClockIcon, InstabilityIcon } from './icons/StatIcons';
...
const Dashboard: React.FC<DashboardProps> = ({ gameState, onMenuToggle, isPaused, onPauseToggle, onSpeedChange }) => {
