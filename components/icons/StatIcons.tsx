...
// Feuille seule (outline + nervures)
// Feuille seule (SVG normalisé 24x24 depuis ton export Inkscape)
export const EcoPointsIcon: React.FC<{ className?: string; strokeWidth?: number }> = ({
                                                                                          className,
                                                                                          strokeWidth = 1.6, // ajuste à 1.5–2 selon le rendu souhaité
                                                                                      }) => (
    <svg
    ...
    >
        <g strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke">
            {/* contours/nervures — conversion de ton SVG (6.35) vers grille 24 */}
            <path d="m10.045 16.2898 s12.9555 8.0587 12.0918 -13.5269" />
            <path d="m10.6836 16.2898 s-7.4056 -7.9472 11.379 -12.734" />
            <path d="m8.4669 22.9795 s1.2644 -9.8438 8.1279 -11.65" />
        </g>
    </svg>
);
...
export const SupportIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.289 2.72a3 3 0 0 1-4.682-2.72 9.094 9.094 0 0 1 3.741-.479m-4.5 3.466a9.094 9.094 0 0 1-3.741.479m11.25 0a9.094 9.094 0 0 0 3.741.479m-11.25 0a3 3 0 0 1 4.682 2.72"/>
...
export const CO2Icon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 1.332-7.257 3 3 0 0 0-5.056-2.257 4.5 4.5 0 0 0-8.522 2.257"/>
    </svg>
);
...
export const PlasticIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M7.5 21V10.5m0 0h9V21m-9-10.5h.008v.008H7.5V10.5Zm.75-5.25h7.5V3h-7.5v2.25Z"/>
    </svg>
);
...
export const MenuIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M10.343 3.94c.09-.542.56-1.008 1.11-1.212l2.39-.816a.75.75 0 0 1 .917.11l1.52 1.52a.75.75 0 0 1 .11.917l-.816 2.39a1.5 1.5 0 0 1-1.212 1.11l-2.39.816a.75.75 0 0 1-.917-.11l-1.52-1.52a.75.75 0 0 1-.11-.917l.816-2.39Zm5.404 14.12c.09-.542.56-1.008 1.11-1.212l2.39-.816a.75.75 0 0 1 .917.11l1.52 1.52a.75.75 0 0 1 .11.917l-.816 2.39a1.5 1.5 0 0 1-1.212 1.11l-2.39.816a.75.75 0 0 1-.917-.11l-1.52-1.52a.75.75 0 0 1-.11-.917l.816-2.39Z"/>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M3.94 10.343c-.542-.09-1.008-.56-1.212-1.11L1.912 6.84a.75.75 0 0 1 .11-.917l1.52-1.52a.75.75 0 0 1 .917-.11l2.39.816c.542.09 1.008.56 1.212 1.11l.816 2.39a.75.75 0 0 1-.11.917l-1.52 1.52a.75.75 0 0 1-.917.11l-2.39-.816Z"/>
...
export const GDPIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.786 11 12 11h-1.25m-2.5 0h-1.25M12 6V5.25a.75.75 0 0 0-.75-.75H10.5a.75.75 0 0 0-.75.75v.75m3.75 0V5.25a.75.75 0 0 0-.75-.75H13.5a.75.75 0 0 0-.75.75v.75m-3.75 0V5.25a.75.75 0 0 0-.75-.75H7.5a.75.75 0 0 0-.75.75v.75M12 6h-1.25m-2.5 0H7.5"/>
    </svg>
);
...
export const RenewableIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M12 12.75V3m0 9.75l-3.375-1.937M12 12.75l3.375-1.937m-3.375 1.937L6.75 21m5.25-8.25L17.25 21"/>
...
export const NuclearIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M12 12.75c-3.142 0-6.044-1.6-7.5-4.018M19.5 8.732c-1.456 2.418-4.358 4.018-7.5 4.018m-7.5 0a7.458 7.458 0 00-2.018 5.018 7.458 7.458 0 002.018 5.018m11.036-10.036a7.458 7.458 0 012.018 5.018 7.458 7.458 0 01-2.018 5.018"/>
...
export const BiodiversityIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M20.25 7.5l-.625 1.063a1.125 1.125 0 01-1.026.625H17.25a1.125 1.125 0 01-1.026-.625L15.5 7.5m-3.5 12.5l.625-1.063a1.125 1.125 0 00-1.026-.625H8.25a1.125 1.125 0 00-1.026.625L6.5 20m7.5-12.5l-1.063.625a1.125 1.125 0 01-1.25 0L11.5 7.5m-1-5.5l.625 1.063a1.125 1.125 0 01-.5 1.563l-3.438 2.063a1.125 1.125 0 01-1.5-.5L3 7.5m1.5 12.5l1.063-.625a1.125 1.125 0 000-1.25L4.5 17.5"/>
    </svg>
);
...
export const CO2TechIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M11.25 12.75c-1.34 0-2.438-.94-2.75-2.188a2.62 2.62 0 010-2.124c.313-1.248 1.41-2.188 2.75-2.188 1.34 0 2.438.94 2.75 2.188a2.62 2.62 0 010 2.124c-.313 1.248-1.41 2.188-2.75 2.188m-5.625 1.875a1.875 1.875 0 100-3.75 1.875 1.875 0 000 3.75m11.25 0a1.875 1.875 0 100-3.75 1.875 1.875 0 000 3.75"/>
...
export const DeforestationTechIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M9.828 15.828a3.75 3.75 0 01-5.304-5.304 3.75 3.75 0 015.304 5.304zM12 12v3.75m0-11.25v3.75m3.75 0H12m-3.75 0H12m9 3.75a3.75 3.75 0 11-5.303-5.303A3.75 3.75 0 0121 12z"/>
    </svg>
);
...
export const WasteTechIcon: React.FC<{ className?: string }> = ({className}) => (
    <svg {...iconProps} className={className || iconProps.className}>
        <path strokeLinecap="round" strokeLinejoin="round"
              d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.182-3.182m0 0v4.992m0 0h-4.992m-4.993 0l-3.181-3.182a8.25 8.25 0 0111.667 0l-3.182 3.182"/>
    </svg>
);
